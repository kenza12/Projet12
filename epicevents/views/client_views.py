...
def create_client():
    ...
    data = {"full_name": full_name, "email": email, "phone": phone, "company_name": company_name}
...
def update_client():
    ...
    full_name = DataValidator.prompt_and_validate(
        "New Full Name (leave blank to skip): ", DataValidator.validate_string, "Full Name", allow_empty=True
    )
    email = DataValidator.prompt_and_validate(
        "New Email (leave blank to skip): ", DataValidator.validate_email, allow_empty=True
    )
    phone = DataValidator.prompt_and_validate(
        "New Phone (leave blank to skip): ", DataValidator.validate_phone, allow_empty=True
    )
    company_name = DataValidator.prompt_and_validate(
        "New Company Name (leave blank to skip): ", DataValidator.validate_string, "Company Name", allow_empty=True
    )
